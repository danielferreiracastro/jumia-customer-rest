...
public class CustomerServiceIntegrationMozambiqueTest extends AbstracBaseClass {
	...
	@Test
	public void getAllCustomersFilteredByCountryMozambique() throws Exception {
		String url = "http://localhost:8080/v1/customers?country=258";
	...
	@Test
	public void getAllCustomersFilteredByCountryMozambiqueNotValid() throws Exception {
		String url = "http://localhost:8080/v1/customers?country=258&state=0";
		MvcResult mvcResult = mvc.perform(MockMvcRequestBuilders.get(url).accept(MediaType.APPLICATION_JSON_VALUE))
				.andReturn();
		String linkText = null;
		Map<String, Integer> pageMap = new HashMap<String, Integer>();
	...
	@Test
	public void getAllCustomersFilteredByCountryMozambiqueValid() throws Exception {
		String url = "http://localhost:8080/v1/customers?country=258&state=1";
		MvcResult mvcResult = mvc.perform(MockMvcRequestBuilders.get(url).accept(MediaType.APPLICATION_JSON_VALUE))
				.andReturn();
		String linkText = null;
		Map<String, Integer> pageMap = new HashMap<String, Integer>();
